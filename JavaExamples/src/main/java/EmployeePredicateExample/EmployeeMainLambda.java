...
public class EmployeeMainLambda {
	...
	public static void main(String[] args) {
		...
		List<Employee> financeEmployeeList = filterEmployeesByDepartment(employeeList, (Employee emp) -> "finance".equals(emp.getDepartmentName()));
		List<Employee> adminEmployeeList = filterEmployeesByDepartment(employeeList, (Employee emp) -> "admin".equals(emp.getDepartmentName()));
